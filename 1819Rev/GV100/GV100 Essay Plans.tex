...
Perhaps a resolution is sovereign by acquisition but then again, the practicality of the solution between irrational man appears to be difficult. We also sumble across the problem og who would be the one initiating the acqusition and if people would conform or attempt to fight their way out $\rightarrow$ they may irrationally not fear the sovereign making the acquisition e.g. British versus Aboriginals in Australia of British versus the Boers in South Africa.
