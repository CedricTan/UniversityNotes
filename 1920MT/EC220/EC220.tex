...
\subsection{A tale of two colleges}
Choices of two colleges:
\begin{itemize}
	\item Harvard University
	\item University of Massachusetts (U-Mass)
\end{itemize}
Large earnings gap between graduates of the two schools but:
\begin{itemize}
	\item Possibly Harvard students have better SATs/ACTs and other talents and are more motivated
	\item Better question to ask: What would the earnings of Harvard students have been if they had gone to U-Mass instead
\end{itemize}
We can narrow the match through analysing a subpopulation
- Earnings of male graduates of Harvard with a SAT of 1,400 vs male graduates of U-Mass with a SAT of 1,400
- Do this for many individuals to exploit the LLN
- Decision to go to Harvard or U-Mass has to be random for this comparison to be good
- 
