...
Tsebelis believes that all political institutions are translated into a series of veto-players. The number and location of veto players affects policy stability, or \textbf{how difficult it is to change the status quo.}
...
If the winset of the status quo exists, its size decreases or remains the same with the addition of new veto players.

If there is a unanimity core, its size increases or remains the same with the addition of new veto players.

\textbf{Hence, the addition of a new veto player increases policy stability or leaves it the same.}
