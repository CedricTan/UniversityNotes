...
\end{tikzpicture}
\end{center}
This is because $A$, $B$ and $C$ control the majority in the government and any agenda put through by the agenda setter, $B$, would be supported by the cohesive party. 
